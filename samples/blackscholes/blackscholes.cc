...
//
// -----------------------------------------------------------------------
// Note: This code is based on sample code take from the Parsec test suite
// See http://parsec.cs.princeton.edu
//
// Copyright (c) 2006-2009, Princeton University
// All rights reserved.
//
// Modified to run with the Google Concurrency Library
// -----------------------------------------------------------------------
